...
After the analysis is complete, generate a new Markdown file in the same folder as the target Verilog file.
...
- Timing diagrams for different operating scenarios, if applicable. Use wavedrom format to draw the waveform. Must cover all scenarios.
